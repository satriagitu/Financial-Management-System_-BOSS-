                              ...
                              <div class="row justify-content-center">
                                   <div class="col-6">
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-8">
                                                  <input type="text" name="uraian_kegiatan_belanja" id="uraian_kegiatan_belanja" class="form-control">
                                             </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-8">
                                                  <input type="text" name="no_kode" id="no_kode" class="form-control">
                                             </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                             ...
                                             <div class="col-sm-8">
                                                  <input type="text" name="penerimaan" id="penerimaan" class="form-control">
                                             </div>
                                        </div>
                                        <div class="form-group row">
                                             <label for="pengeluaran" class="col-sm-4">Pengeluaran</label>
                                             <div class="col-sm-8">
                                                  <input type="text" name="pengeluaran" id="pengeluaran" class="form-control">
                                             </div>
                                        </div>
                                        <div class="form-group row">
                                                  ...
                                                  <select name="kena_pajak" id="kena_pajak" class="form-control">
                                                       ...
                                                       <?php
                                                            foreach($kena_pajak as $row){
                                                                 echo "<option value=".$row->id.">".$row->kena_pajak."</option>";
                                                            }
                                                       ?>
                                                  </select>
                                             </div>
...
<script>
     ...
     function save() {
          ...
          if (uraian_kegiatan_belanja != '' 
               ...
               $.ajax({
                    url: "<?php echo base_url(); ?>Buku/save_add",
                    type: "POST",
                    data: $("#form").serialize(),
                    dataType: "JSON",
