                                                       ...
                                                       foreach($data as $row){
                                                            echo "                                   
                                                                      <tr>
                                                                           ...
                                                                           <td>
                                                                                <img src=".(base_url('assets/img/kwitansi/').$row->image)." width='200px'>
                                                                           </td>
                                                                           <td>
                                                                                <a href='".base_url().'Kwitansi/edit/'.$row->id."' class='btn btn-success btn-circle btn-sm' title='Edit'>
...
<script>
     function tambah_data() {
          window.location.href = "<?= site_url('Kwitansi/tambah') ?>";
     }
     ...
     function hapus(id){
          ...
          Swal.fire({
               ...
               if (result.isConfirmed) {
                    ...
                    $.ajax({
                         url: "<?php echo base_url(); ?>Kwitansi/delete/" + id,
                         type: "POST",
                         data: $("#form").serialize(),
                         dataType: "JSON",
